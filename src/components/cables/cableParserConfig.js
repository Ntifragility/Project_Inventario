...
export const CABLE_SCHEDULE_COLUMNS = {
  ...
  servicio:                { label: 'SERVICIO',                required: false, type: 'text' },
  codigo:                  { label: 'CODIGO',                  required: false, type: 'text' },
  sistema:                 { label: 'SISTEMA',                 required: false, type: 'text' },
  capacidad:               { label: 'CAPACIDAD',               required: false, type: 'text' },
  ...
  canal_ruteo:             { label: 'CANAL DE RUTEO',          required: false, type: 'text' },
  tipo_cable:              { label: 'TIPO DE CABLE',           required: false, type: 'text' },
  ...
  tendido_por:             { label: 'TENDIDO POR',             required: false, type: 'text' },
